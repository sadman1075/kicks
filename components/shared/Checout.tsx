        ...
        <AosWrapper>
            <section className="max-w-7xl mx-auto p-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {/* Details*/}
                    <Card data-aos="fade-right" className="lg:col-span-2 rounded-2xl">
                    ...
                    {/* Order Summary */}
                    <Card data-aos="fade-left" className="rounded-2xl h-fit bg-[#e7e7e3] shadow-none">
                        <CardContent className="p-6">
                ...
                <div>
                    <div className="max-w-7xl mx-auto mt-10 md:mt-20">
                        <div className="flex justify-between  px-5  items-center">
                            <h1 data-aos="fade-right" className="text-lg md:text-5xl font-bold">You may also like</h1>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-0 lg:p-4'>
                            {products.length === 0 ? (
                                <div className="flex w-full h-40 items-center justify-center text-gray-500 text-lg">
                                    There is no similar product at this moment
                                </div>
                            ) : (
